...
import { MembershipRecordFilters } from "../types/membership-record";
import { Input } from "@/components/ui/input";
import { Search } from "lucide-react";
import { cn } from "@/lib/utils";

interface MembershipRecordsFiltersProps {
  filters: MembershipRecordFilters;
  onFiltersChange: (filters: Partial<MembershipRecordFilters>) => void;
}

export function MembershipRecordsFilters({
  filters,
  onFiltersChange,
}: MembershipRecordsFiltersProps) {
