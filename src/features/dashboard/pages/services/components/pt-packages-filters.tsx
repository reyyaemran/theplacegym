...
import { PTPackageFilters } from "../types/pt-package";
import { cn } from "@/lib/utils";

interface PTPackagesFiltersProps {
  filters: PTPackageFilters;
  onFiltersChange: (filters: PTPackageFilters) => void;
}

export function PTPackagesFilters({
  filters,
  onFiltersChange,
}: PTPackagesFiltersProps) {
