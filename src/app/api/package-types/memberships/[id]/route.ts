...
export async function GET(
  ...
  try {
    ...
    try {
      ...
      logger.error("package-types/memberships/[id] GET: database unavailable", undefined, { message: msg });
...
export async function PUT(
  ...
  try {
    ...
    try {
      ...
      const msg = error instanceof Error ? error.message : String(error);
      logger.error("package-types/memberships/[id] PUT: database unavailable", undefined, { message: msg });
      return dbUnavailable();
    }
...
export async function DELETE(
  ...
  try {
    ...
    try {
      ...
      const msg = error instanceof Error ? error.message : String(error);
      logger.error("package-types/memberships/[id] DELETE: database unavailable", undefined, { message: msg });
      return dbUnavailable();
    }
